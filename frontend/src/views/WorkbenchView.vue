...
import { downloadGedcom } from '../features/gedcom/gedcom'
    ...
    <main class="workspace">
      <section class="editor-workspace">
        <WorkbenchPanels
          ...
          :pubId="context.serverPublicationId.value"
          ...
          @toggle-validation="validationOpen = !validationOpen"
...
<style scoped>
.app-shell {
  --workbench-header-bg: var(--color-panel-bg);
  --workbench-header-border: var(--color-card-stroke);
  --workbench-header-shadow: var(--shadow-whisper);
  --workbench-panel-bg: var(--color-panel-bg);
  --workbench-panel-strong: var(--color-card-fill);
  --workbench-panel-muted: var(--color-neutral-3);
  ...
  --workbench-accent-text: var(--color-text-on-accent);
  --bg-panel: var(--workbench-panel-bg);
  --bg-panel-strong: var(--workbench-panel-strong);
  --bg-paper: var(--color-card-fill);
  --line-soft: var(--workbench-line-soft);
  --text-main: var(--workbench-text-main);
  --text-sub: var(--workbench-text-sub);
  --text-soft: var(--workbench-text-soft);
  --accent-earth: var(--workbench-accent-strong);
  --accent-btn-bg: var(--workbench-accent-bg);
  --accent-btn-color: var(--workbench-accent-text);
  --glass-border-highlight: var(--color-glass-border-highlight);
  --glass-border-shadow: var(--color-glass-border-shadow);
  min-width: 0;
  min-height: 100vh;
