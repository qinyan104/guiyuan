...
export const LEXICONS: Record<LexiconId, LexiconConfig> = {
  standard: {
    ...
    dashboard: {
      ...
      headerEyebrow: '系统概览',
      headerTitle: '工作台',
      headerTitleItalic: '概览',
      quote: '数字化族谱管理系统，清晰记录家族世系与档案数据。',
      heroLabel: '最近编撰',
      statPubsLabel: '族谱总数',
      statUsersLabel: '系统成员',
      quickActionTitle: '新建族谱',
  ...
  archive: {
    ...
    dashboard: {
      label: '卷首',
      soul: '源',
      headerEyebrow: '卷之一 · 总览',
      headerTitle: '族谱',
      headerTitleItalic: '卷首',
      quote: '家族史是一条奔流不息的长河，\\n我们在此记录每一个浪花的归宿。',
      heroLabel: '最新修撰',
      statPubsLabel: '馆藏总卷',
      statUsersLabel: '守藏编委',
      quickActionTitle: '起草新谱',
  ...
  shrine: {
    ...
    dashboard: {
      ...
      headerEyebrow: '正庭 · 肃穆',
      headerTitle: '宗族',
      headerTitleItalic: '明堂',
      quote: '祖宗虽远，祭祀不可不诚；\\n子孙虽愚，经书不可不读。',
      heroLabel: '当值修谱',
      statPubsLabel: '宗谱总册',
      statUsersLabel: '执事名录',
      quickActionTitle: '修撰宗谱',
  ...
  poetic: {
    ...
    dashboard: {
      ...
      headerEyebrow: '首篇 · 寻根',
      headerTitle: '万物',
      headerTitleItalic: '溯源',
      quote: '树高千丈，落叶归根；\\n水流万里，溯流思源。',
      heroLabel: '近览世系',
      statPubsLabel: '琅嬛总卷',
      statUsersLabel: '同道中人',
      quickActionTitle: '溯源立谱',
...
export const useLexiconStore = defineStore('lexicon', () => {
  ...
  const lexicons = computed(() => Object.values(LEXICONS))
