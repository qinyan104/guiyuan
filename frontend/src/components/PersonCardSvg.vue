...
const compactLineColor = computed(() => {
  ...
  return configuredColor && configuredColor.toLowerCase() !== '#c43a31' ? configuredColor : DEFAULT_COMPACT_LINE_COLOR
})
...
<style scoped src="./PersonCardSvg.style" lang="css"></style>
